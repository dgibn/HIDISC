...
source_domains_mapping = {
    'Office_Home': {
        "Art": f"/HypDGCD/checkpoints/{args.dataset_name}/Art/Intermediate_Art_hyper_dbus_cut_trained_model_c0.03_{args.checkpoint}.pkl",
        "Clipart": f"/HypDGCD/checkpoints/{args.dataset_name}/Clipart/Intermediate_Clipart_hyper_dbus_cut_trained_model_c0.03_{args.checkpoint}.pkl",
        "Product": f"/HypDGCD/checkpoints/{args.dataset_name}/Product/Intermediate_Product_hyper_dbus_cut_trained_model_c0.03_{args.checkpoint}.pkl",
        "Real_world": f"/HypDGCD/checkpoints/{args.dataset_name}/Real_world/Intermediate_Real_world_hyper_dbus_cut_trained_model_c0.03_{args.checkpoint}.pkl"
    },
    'PACS': {
