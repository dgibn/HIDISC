...
source_domains_mapping = {
    'Office_Home': {
        "Art": f"checkpoints/{args.dataset_name}/Art/Intermediate_Art__trained_model_{args.checkpoint}.pkl",
        "Clipart": f"checkpoints/{args.dataset_name}/Clipart/Intermediate_Clipart__trained_model_{args.checkpoint}.pkl",
        "Product": f"checkpoints/{args.dataset_name}/Product/Intermediate_Product__trained_model_{args.checkpoint}.pkl",
        "Real_world": f"checkpoints/{args.dataset_name}/Real_world/Intermediate_Real_world__trained_model_{args.checkpoint}.pkl"
    },
    'PACS': {
        "art_painting": f"checkpoints/{args.dataset_name}/art_painting/Intermediate_art_painting__trained_model_{args.checkpoint}.pkl",
        "photo": f"checkpoints/{args.dataset_name}/photo/Intermediate_photo__trained_model_{args.checkpoint}.pkl",
        "cartoon": f"checkpoints/{args.dataset_name}/cartoon/Intermediate_cartoon__trained_model_{args.checkpoint}.pkl",
        "sketch": f"checkpoints/{args.dataset_name}/sketch/Intermediate_sketch__trained_model_{args.checkpoint}.pkl"
    },
    'Domain_Net': {
        "clipart": f"checkpoints/{args.dataset_name}/clipart/Intermediate_clipart__trained_model_{args.checkpoint}.pkl",
        "sketch": f"checkpoints/{args.dataset_name}/sketch/Intermediate_sketch__trained_model_{args.checkpoint}.pkl",
        "painting": f"checkpoints/{args.dataset_name}/painting/Intermediate_painting__trained_model_{args.checkpoint}.pkl",
    }
}
